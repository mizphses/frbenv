...
sudo apt -y install git zlib1g-dev autoconf bison build-essential libssl-dev libyaml-dev libreadline-dev libncurses5-dev libffi-dev libgdbm-dev libdb-dev openssl
